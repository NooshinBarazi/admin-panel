      ...
      <div className="sidebar-content">
        ...
        <ul className="sidebar-nav pe-0">
          ...
          <li className="sidebar-item">
            <NavLink className={({isActive})=> isActive? 'sidear-link active': 'sidebar-link'} to={'/'}>
              <svg
          ...
          <li className="sidebar-item">
            <NavLink className={({isActive})=> isActive? 'sidear-link active': 'sidebar-link'} to={'/course-categories'}>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
